...
const sections = [
   {
	...
	rows: [
	    ...
	    {title: "🔥Virus Troli", rowId: '.virustroli', description: 'Jangan lupa Subs Yt ᴹᴿ᭄ Vincentt ? ×፝֟͜× Offcial' },
	    {title: "🔥Virus Power", rowId: '.powerlist', description: 'Jangan lupa Subs Yt ᴹᴿ᭄ Vincentt ? ×፝֟͜× Offcial' },
	    ]
        }, {
    title: `✃ BUY`,
	rows: [
